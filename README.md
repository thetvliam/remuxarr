...
The frontend has its own suite - 230 tests covering the app's central state
...
handling, and the theme serialiser that round-trips a theme between its
source text and the object the app renders from:
