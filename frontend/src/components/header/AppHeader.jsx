...
export const AppHeader = ({
  ...
  scanning, scanProgress, onTriggerScan,
  wsConnected,
}) => {
      ...
      <header style={{
        ...
        <button
          ...
          style={{
            ...
            background: "transparent",
            border: `1px solid ${scanning ? C.amber : C.border}`,
            color: scanning ? C.amber : C.dim,
        ...
        <>
          ...
          <div style={{
            ...
            <div style={{ padding: "10px 14px", display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              {/* Scan */}
              <button
                onClick={() => { if (!scanning) { onTriggerScan(); closeDrawer(); } }}
                disabled={scanning}
                style={{
                  padding: "10px 14px", textAlign: "left",
                  background: "transparent",
