...
const midnight = {
  ...
  label: "Midnight",
  colorScheme: "dark",
  blurb: "Cool slate and soft neon. Rounded, roomy, low-contrast chrome with bright status colour.",
  palette: midnightPalette,
  statusColor: buildStatusColor(midnightPalette),
  levelColor: buildLevelColor(midnightPalette),
  toastTone: buildToastTone(midnightPalette),
  actionCfg: buildActionCfg(midnightPalette, {
    green: "#11221d",
    greenB: "#183728",
    red: "#23171c",
    redB: "#3a2125",
  ...
  type: {
    family: "inherit",
    root: "'Inter Variable', 'Inter', system-ui, sans-serif",
  ...
  surface: {
    badgeFallbackBg: "#1a1f29",
    dryRunBg: "#1a1533",
    rowHoverBg: "#ffffff08",
    drawerShadow: "0 4px 16px #00000080",
    logoInk: "#0b0d12",
    reviewBorder: "#3f3520",
    trackRowBg: "#00000033",
    rowSelectedBg: "#ffffff0d",
...
const dawn = {
  ...
  label: "Dawn",
  colorScheme: "light",
  blurb: "Paper white with ink-dark text. Every overlay inverted for a light background.",
  palette: dawnPalette,
  statusColor: buildStatusColor(dawnPalette),
  levelColor: buildLevelColor(dawnPalette),
  toastTone: buildToastTone(dawnPalette),
  actionCfg: buildActionCfg(dawnPalette, {
    green: "#e4efea",
    greenB: "#cde2d7",
    red: "#f4e5e7",
    redB: "#eeced0",
  ...
  surface: {
    badgeFallbackBg: "#eef0f4",
    dryRunBg: "#f6f2ff",
    rowHoverBg: "#00000008",
    drawerShadow: "0 4px 16px #0f172a1f",
    logoInk: "#ffffff",
    reviewBorder: "#e6d3a8",
    trackRowBg: "#00000008",
    rowSelectedBg: "#0000000f",
    logBg: "#f4f5f8",
    logMeta: "#7b8394",
    logText: "#1f2430",
    zebraBg: "#00000005",
    modalScrimBg: "#0f172a80",
    errorBg: "#fdf1f1",
    guardScrimBg: "rgba(15,23,42,0.45)",
  },
};
...
const paper = {
  ...
  label: "Paper",
  colorScheme: "light",
  blurb: "Terminal on white. Same density, spacing and type - only the colours differ.",
  palette: paperPalette,
  statusColor: buildStatusColor(paperPalette),
  levelColor: buildLevelColor(paperPalette),
  toastTone: buildToastTone(paperPalette),
  actionCfg: buildActionCfg(paperPalette, {
    green: "#edfcf3",
    greenB: "#bdf5d5",
    red: "#fdf3f3",
    redB: "#f8d7d7",
...
const linen = {
  ...
  label: "Linen",
  colorScheme: "light",
  blurb: "Soft on white. Same rounded spacing and type - only the colours differ.",
  palette: linenPalette,
  statusColor: buildStatusColor(linenPalette),
  levelColor: buildLevelColor(linenPalette),
  toastTone: buildToastTone(linenPalette),
  actionCfg: buildActionCfg(linenPalette, {
    green: "#edfaf3",
    greenB: "#dcf6e8",
    red: "#fcecec",
    redB: "#fce5e5",
...
export const themes = { terminal, soft, midnight, dawn, paper, linen };
